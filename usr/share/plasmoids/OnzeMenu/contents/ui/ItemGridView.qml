...
FocusScope {
    ...
    property alias numColumns: gridView.numColumns
    ...
    DropArea {
        ...
        PlasmaExtras.ScrollArea {
            ...
            GridView {
                ...
                delegate:  square ? aItemGridDelegate2 :  ( itemGrid.numColumns === 1 ? aItemGridDelegate3 : aItemGridDelegate)
                ...
                Keys.onDownPressed: {
                    if (currentRow() < itemGrid.lastRow()) {
                        ...
                        itemGrid.keyNavDown();currentRow
                    }
                }
        ...
        MouseArea {
            ...
            onPressed: {
                ...
                updatePositionProperties(mouse.x, mouse.y);false
