...
PlasmaCore.Dialog {
    ...
    FocusScope {
        ...
        Item{
            ...
            XAnimator{
                id: mainScrollAreaAnimation
                target: allAppsGrid
                from: units.gridUnit * 15
                to: units.largeSpacing
        ...
        ItemGridView3 {
            ...
            height: (units.iconSizes.medium + units.smallSpacing * 4) * 3
            width: parent.width - units.largeSpacing * 2
            cellWidth:    width * 0.5
            cellHeight:   units.iconSizes.medium + units.smallSpacing * 4
            iconSize:    units.iconSizes.medium * 2
            verticalScrollBarPolicy: Qt.ScrollBarAlwaysOff
