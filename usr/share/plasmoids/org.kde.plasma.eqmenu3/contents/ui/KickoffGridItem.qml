...
Item {
    ...
    implicitWidth: gridItem.iconSize + (25 * units.smallSpacing) // limit minimum width so that at least some letters are visible
    implicitHeight: (gridItem.enableSubtitles)
            ? (units.smallSpacing * 2) + Math.max(gridItem.iconSize, titleElement.implicitHeight + subTitleElement.implicitHeight)
            : (units.smallSpacing * 2) + Math.max(gridItem.iconSize, titleElement.implicitHeight)
    ...
    PlasmaComponents.Label {
        ...
        visible: (gridItem.enableSubtitles === true)
    ...
    states: [
        State {
            ...
            PropertyChanges {
                ...
                implicitHeight: (units.smallSpacing * 2) + gridItem.iconSize
            }
            AnchorChanges {
                target: elementIcon
                anchors {
        ...
        State {
            ...
            PropertyChanges {
                target: gridItem
                implicitWidth: gridItem.iconSize + elementIcon.anchors.leftMargin + elementIcon.anchors.rightMargin
                implicitHeight: (gridItem.enableSubtitles === true)
                        ? elementIcon.anchors.topMargin + gridItem.iconSize + (units.smallSpacing * 1)
                            + titleElement.implicitHeight + subTitleElement.implicitHeight
                        : elementIcon.anchors.topMargin + gridItem.iconSize + (units.smallSpacing * 2)
