...
Item {
  ...
  Rectangle {
    ...
    property variant images: [
        "file:///usr/share/backgrounds/login/1.jpg",
        "file:///usr/share/backgrounds/login/2.jpg",
        "file:///usr/share/backgrounds/login/3.jpg",
        "file:///usr/share/backgrounds/login/4.jpg",
        "file:///usr/share/backgrounds/login/5.jpg",
        "file:///usr/share/backgrounds/login/6.jpg",
        "file:///usr/share/backgrounds/login/7.jpg",
        "file:///usr/share/sddm/themes/sddm-peux-os-clairvoyance/Assets/Background.jpg",
    ]
        ...
        source: {
            ...
            for (var i = 0 ; i <= images.length; --i )
            {
                ...
                switch(i){
                    ...
                    case 5: return images[i++];
                    case 6: return images[i++];
                    case 7: return images[i++];
                    
        //            case 8: ....
                    //default: return "file:///usr/share/backgrounds/photo-1607925594479-981bed7b2dbb.jpg"
